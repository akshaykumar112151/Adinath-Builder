...
import Takshshilaimg2 from "./img/Takshshilaimg2.jpg";
    ...
    <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
           ...
           <div className="carousel-inner">
             <div className="carousel-item active">
               <img src={Takshshilaimg1} className="d-block w-100 carousel-image" alt="..." />
             ...
             <div className="carousel-item">
               <img src={Takshshilaimg2} className="d-block w-100 carousel-image" alt="..." />
               <div className="overlayy"></div>
               <div className="carousel-caption d-md-block centered-caption"><br /><br /><br />
         ...
         <div className="tour-details">
           <h2 className="tour-title text-white">Adinath's Takshshila</h2>
     ...
     <a href="/TakshshilaBrochure.pdf" target="_blank" rel="noopener noreferrer" className="bounce-effect">
       <img src={downloads} alt="Icon" width="45" height="45" />
     </a>
   </div>
   
                 </span>
                 <span className="label text-white"> Takshshila Brochure<br />
       ...
       <g fill="none" fillRule="evenodd">
         ...
         <div className="overview-contact-wrapper">
           <div className="overview-container">
             ...
             <h4 className='vedpuramtext text-start ms-3'>Takshshila – A Perfect Blend of Modern Living & Tranquility</h4>
             <p className="overview-text text-start ms-3">
             Welcome to Takshshila Colony, a thoughtfully planned residential development that offers the ideal combination of luxury and serenity. With cutting-edge infrastructure and an exceptional location, Takshshila Colony provides the perfect setting to build your dream home. Experience an unparalleled balance of comfort, convenience, and natural beauty.             </p>
             <h5 className='vedpuramtext text-start ms-3'>Prime Location for a Bright Future</h5>
             <p className="overview-text text-start ms-3">
             Located in a rapidly growing area, Takshshila Colony offers seamless access to urban conveniences while maintaining a peaceful environment. With expansive roads, vibrant green spaces, and a meticulously designed layout, this development promises a refined lifestyle for its residents.  </p>
                 <h5 className='vedpuramtext text-start ms-3'>World-Class Amenities & Well-Designed Infrastructure
                 </h5>
             <p className="overview-text text-start ms-3">
             At Takshshila Colony, every detail is curated to ensure an elevated living experience, featuring:<ul className="mt-3 ms-0 space-y-2 ">
           <li>✅ <strong>Well-Planned & Wide Roads</strong> – Ensuring smooth transportation within the community.</li>
           <li>✅ <strong>Lush Green Landscaping</strong> – Bringing you closer to nature.</li>
         ...
         <h2 className='vedpuramtext text-start ms-3'>Your Ideal Home Awaits!</h2>
         <p className="overview-text text-start ms-3">With state-of-the-art infrastructure, serene surroundings, and top-tier amenities, Takshshila Colony offers more than just a home; it’s a lifestyle choice for those who appreciate the perfect blend of urban convenience and natural beauty.</p>
         ...
         <iframe
        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3551.774370474826!2d78.03364147544599!3d27.10040937653582!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjfCsDA2JzAxLjUiTiA3OMKwMDInMTAuNCJF!5e0!3m2!1sen!2sin!4v1743491904896!5m2!1sen!2sin"
        width="600"
        height="450"
        style={{ border: '0' }}
        allowFullScreen
