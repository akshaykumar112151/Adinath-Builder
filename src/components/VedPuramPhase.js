...
import "./VedPuramPhase.css";
import ContacctForm from './ContacctForm';
// import Same1Day from "./img/Same1Day.jpg";
import VedPuram from "./img/VedPuram-1.png";
import VedPuram2 from "./img/VedPuram2.png";
...
const images = [
  ...
  { id: 1, src: Veddpuram1, alt: 'Image 1 description',  },
  { id: 2, src: Veddpuram2, alt: 'Image 2 description',  },
  { id: 3, src: Veddpuram3, alt: 'Image 3 description',  },
  { id: 4, src: Veddpuram4, alt: 'Image 4 description',  },
  { id: 5, src: Veddpuram5, alt: 'Image 5 description',  },
  { id: 6, src: Veddpuram6, alt: 'Image 6 description', },
  { id: 7, src: Veddpuram7, alt: 'Image 7 description', },
  { id: 8, src: Veddpuram8, alt: 'Image 8 description',  },
  { id: 9, src: Veddpuram9, alt: 'Image 1 description',  },
  { id: 10, src: Veddpuram10, alt: 'Image 2 description',  },
  { id: 11, src: Veddpuram11, alt: 'Image 3 description',  },
  { id: 12, src: Veddpuram12, alt: 'Image 4 description',  },
  { id: 13, src: Veddpuram13, alt: 'Image 5 description',  },
  { id: 14, src: Veddpuram14, alt: 'Image 6 description', },
  { id: 15, src: Veddpuram15, alt: 'Image 7 description', },
  { id: 16, src: Veddpuram16, alt: 'Image 8 description',  },
 ...
 <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={VedPuram} className="d-block w-100 carousel-image" alt="..." />
      ...
      <div className="tour-details">
        <h2 className="tour-title text-white">Adinath VedPuram Phase 2</h2>
  ...
  <a href="/VedPuramBrochure.pdf" target="_blank" rel="noopener noreferrer" className="bounce-effect">
    <img src={downloads} alt="Icon" width="45" height="45" />
  </a>
</div>

              </span>
              <span className="label text-white"> Ved PuramBrochure<br />
...
>
  ...
  >
    <g fill="none" fillRule="evenodd">
      ...
      <div className="overview-contact-wrapper">
        <div className="overview-container">
          ...
          <h4 className='vedpuramtext text-start ms-3'>Ved Puram Phase 2 – An Ideal Living Experience by Adinath Builders.</h4>
          <p className="overview-text text-start ms-3">
          Welcome to Ved Puram Phase 2, a thoughtfully planned residential community by Adinath Builders, where modern living meets tranquility. Designed with precision and elegance, this premium development offers an ideal blend of comfort, luxury, and convenience, making it the perfect place to build your dream home.
          </p>
          <h5 className='vedpuramtext text-start ms-3'>A Perfect Location for a Prosperous Future</h5>
          <p className="overview-text text-start ms-3">
          Nestled in a prime location, Ved Puram Phase 2 provides excellent connectivity to essential urban conveniences while maintaining a peaceful ambiance. With well-developed infrastructure, wide roads, and lush green surroundings, this residential project ensures a high-quality lifestyle for its residents.      
              </p>
              <h5 className='vedpuramtext text-start ms-3'>Modern Amenities & Premium Infrastructure
              </h5>
          <p className="overview-text text-start ms-3">
          At Ved Puram Phase 2, every detail has been meticulously crafted to provide a seamless living experience. The project boasts:
          <ul className="mt-3 ms-0 space-y-2 ">
        <li>✅ <strong>Wide & Well-Paved Roads</strong> – Ensuring smooth transportation within the community.</li>
        <li>✅ <strong>Beautifully Landscaped Spaces</strong> – Bringing you closer to nature.</li>
        <li>✅ <strong>Secure Gated Community</strong> – With round-the-clock security for peace of mind.</li>
        <li>✅ <strong>Adequate Water & Electricity Supply</strong> – Ensuring a hassle-free living experience.</li>
    ...
    <iframe 
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3549.9626034827036!2d77.9472188!3d27.1347481!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39747750fbd93fad%3A0xd288698df9f60e34!2sAdinath%20Ved%20puram%20Housing%20Colony!5e0!3m2!1sen!2sin!4v1711717200000!5m2!1sen!2sin"
        allowFullScreen
        loading="lazy"
        title="Google Map"
    ></iframe>
