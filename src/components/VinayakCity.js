...
import VinayakCityimg2 from "./img/VinayakCityimg2.jpg";
    ...
    <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
           ...
           <div className="carousel-inner">
             <div className="carousel-item active">
               <img src={VinayakCityimg1} className="d-block w-100 carousel-image" alt="..." />
             ...
             <div className="carousel-item">
               <img src={VinayakCityimg2} className="d-block w-100 carousel-image" alt="..." />
               <div className="overlayy"></div>
               <div className="carousel-caption d-md-block centered-caption"><br /><br /><br />
         ...
         <div className="tour-details">
           <h2 className="tour-title text-white">Adinath Vinayak City</h2>
     ...
     <a href="/VinayakCityBrochure.pdf" target="_blank" rel="noopener noreferrer" className="bounce-effect">
       <img src={downloads} alt="Icon" width="45" height="45" />
     </a>
   </div>
   
                 </span>
                 <span className="label text-white"> Vinayak City Brochure<br />
       ...
       <g fill="none" fillRule="evenodd">
         ...
         <div className="overview-contact-wrapper">
           <div className="overview-container">
             ...
             <h4 className='vedpuramtext text-start ms-3'>Vinayak City – A Perfect Blend of Modern Living & Serenity</h4>
             <p className="overview-text text-start ms-3">
             Welcome to Vinayak City, a meticulously designed residential township that redefines luxurious yet peaceful living. With state-of-the-art infrastructure and a prime location, Vinayak City is the perfect place to build your dream home, offering an unmatched blend of comfort, convenience, and natural beauty.
             </p>
             <h5 className='vedpuramtext text-start ms-3'>Prime Location for a Bright Future</h5>
             <p className="overview-text text-start ms-3">
             Situated in a well-connected and rapidly developing area, Vinayak City ensures seamless accessibility to all essential urban conveniences while maintaining a tranquil atmosphere. With wide roads, lush green landscapes, and a thoughtfully planned layout, this project promises an elevated lifestyle for its residents.                 </p>
                 <h5 className='vedpuramtext text-start ms-3'>Premium Amenities & Thoughtfully Designed Infrastructure
                 </h5>
             <p className="overview-text text-start ms-3">
             At Vinayak City, every aspect has been crafted to provide a superior living experience, featuring:             <ul className="mt-3 ms-0 space-y-2 ">
         ...
         <h2 className='vedpuramtext text-start ms-3'>Your Dream Home Awaits!</h2>
         <p className="overview-text text-start ms-3">With its modern infrastructure, serene environment, and world-class amenities, Vinayak City is more than just a residential project—it’s a lifestyle choice for those who seek the best of urban convenience and natural beauty.</p>
         ...
         <iframe
        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3553.041752487207!2d77.98486299999999!3d27.06043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjfCsDAzJzM3LjYiTiA3N8KwNTknMDUuNSJF!5e0!3m2!1sen!2sin!4v1743486863208!5m2!1sen!2sin"
        width="600"
        height="450"
        style={{ border: '0' }}
        allowFullScreen
