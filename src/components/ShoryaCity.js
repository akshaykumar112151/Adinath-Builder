...
import './ShoryaCity.css';

import Shouryaimg1 from "./img/Shouryaimg1.webp";
import Shouryaimg2 from "./img/Shouryaimg2.webp";
...
import Shoryaimg14 from "./img/Shoryaimg14.jpg";
import Shoryaimg15 from "./img/Shoryaimg15.jpg";
...
const images = [
  ...
  { id: 5, src: Shoryaimg7, alt: 'Image 5 description',  },
  { id: 6, src: Shoryaimg8, alt: 'Image 6 description', },
  { id: 7, src: Shoryaimg9, alt: 'Image 7 description', },
  { id: 8, src: Shoryaimg10, alt: 'Image 8 description',  },
  { id: 9, src: Shoryaimg11, alt: 'Image 9 description',  },
  { id: 10,src: Shoryaimg12, alt: 'Image 10 description', },
  { id: 11,src:Shoryaimg13, alt: 'Image 11 description', },
  
  { id: 14, src: Shoryaimg14, alt: 'Image 14 description',  },
  { id: 15, src: Shoryaimg15, alt: 'Image 15 description',  },
    ...
    <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
           ...
           <div className="carousel-inner">
             <div className="carousel-item active">
               <img src={Shouryaimg1} className="d-block w-100 carousel-image" alt="..." />
             ...
             <div className="carousel-item">
               <img src={Shouryaimg2} className="d-block w-100 carousel-image" alt="..." />
               <div className="overlayy"></div>
               <div className="carousel-caption d-md-block centered-caption"><br /><br /><br />
         ...
         <div className="tour-details">
           <h2 className="tour-title text-white">Adinath's Shorya City</h2>
     ...
     <a href="/ShoryaCityBrochure.pdf" target="_blank" rel="noopener noreferrer" className="bounce-effect">
       <img src={downloads} alt="Icon" width="45" height="45" />
     </a>
   </div>
   
                 </span>
                 <span className="label text-white"> Shorya City Brochure<br />
     ...
     >
       <g fill="none" fillRule="evenodd">
         ...
         <div className="overview-contact-wrapper">
           <div className="overview-container">
             ...
             <h4 className='vedpuramtext text-start ms-3'>Shorya City – A Perfect Blend of Comfort & Modern Living</h4>
             <p className="overview-text text-start ms-3">
             Welcome to Shorya City, a thoughtfully designed residential community that harmonizes luxury, peace, and convenience. Nestled in a prime location, Shorya City offers an unparalleled living experience with well-planned infrastructure, lush green landscapes, and top-tier amenities. It’s not just a place to live—it’s a lifestyle designed for those who seek elegance, comfort, and seamless urban connectivity.</p>
             <h5 className='vedpuramtext text-start ms-3'>Prime Location with Endless Opportunities</h5>
             <p className="overview-text text-start ms-3">
             Strategically located in a rapidly growing area, Shorya City ensures easy access to modern urban facilities while maintaining a serene and tranquil environment. The colony features wide, well-structured roads, open green spaces, and a carefully planned layout, promising an elevated and sophisticated lifestyle for its residents.</p>
                 <h5 className='vedpuramtext text-start ms-3'>World-Class Amenities & Thoughtful Infrastructure
                 </h5>
             <p className="overview-text text-start ms-3">
             Every detail in Shorya City is crafted to provide a premium living experience, offering:<ul className="mt-3 ms-0 space-y-2 ">
         ...
         <h2 className='vedpuramtext text-start ms-3'>Build Your Dream Home in Shorya City!</h2>
         <p className="overview-text text-start ms-3">With modern infrastructure, a serene atmosphere, and premium facilities, Shorya City is more than just a residential project—it’s a gateway to a future filled with comfort, security, and happiness. Make the smart choice today and become a part of this thriving community!</p>
      ...
      {selectedImageIndex !== null && (
        <div className="image-viewer">
         ...
         <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3551.380171929467!2d77.9197032!3d27.112833199999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39738a0462f2e63b%3A0x42f91710d726eba0!2sS.%20S.%20Educational%20Institute!5e0!3m2!1sen!2sin!4v1743575255873!5m2!1sen!2sin"
        width="600"
        height="450"
        style={{ border: '0' }}
        allowFullScreen
